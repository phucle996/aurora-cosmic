"""Hardware & Device Resolution for Training (CPU vs CUDA)."""
...
class DeviceTargetUnavailableError(ComputeTargetError):
    """Raised when CUDA target was requested but hardware/driver is missing."""
