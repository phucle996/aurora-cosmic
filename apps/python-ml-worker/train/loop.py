"""Candidate Vetting Model Training Loop & Metrics."""
...
from train.device import resolve_training_device
...
def train_candidate_model(
    ...
    output_dir = (
        ...
        if dest_dir
            ...
            tempfile.gettempdir(), "aurora-ml-training", spec.training_run_id
        )
    )
