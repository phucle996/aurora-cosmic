...
export default function InferenceEngineSection(): JSX.Element {
  const {
    models,
    selectedModel,
    selectedRuntimeId,
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
            Theo dõi và retry batch scoring trên Rust GPU runtime; mỗi job được pin vào model và Gold artifact cụ thể.
          </p>
        </div>
