  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="glass-card p-5">
        ...
        <div className="text-2xl font-semibold text-white mt-2">128,490</div>
      ...
      <div className="glass-card p-5">
        ...
        <div className="text-2xl font-semibold text-white mt-2">14.2 / 50.0 GB</div>
      ...
      <div className="glass-card p-5">
        ...
        <div className="text-2xl font-semibold text-white mt-2">3,421</div>
      ...
      <div className="glass-card p-5">
        ...
        <div className="text-2xl font-semibold text-white mt-2">412</div>
