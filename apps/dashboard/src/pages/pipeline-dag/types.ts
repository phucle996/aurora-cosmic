import type { BLSSearchEvidence, CandidateAssemblyEvidence, GoldCommitEvidence, GoldMaterializationEvidence, GoldProjectionEvidence, LCFeatureEvidence, TPFSpatialEvidence } from '@/types/ticket';
