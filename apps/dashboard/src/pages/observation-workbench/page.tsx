...
export default function ObservationWorkbenchPage(): JSX.Element {
        ...
        <CardHeader className="border-b border-border/60 bg-muted/15 pb-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <CardDescription className="mt-1">Source: ClickHouse lightcurve index committed with the selected Gold snapshot. No generated points or inferred trend are shown.</CardDescription>
            </div>
            <div className="flex gap-2">
              <Button asChild size="sm" variant="outline"><Link to={`/research-factory/workbench/${selected.tic_id}?sector=${selected.sector}${selected.gold_snapshot_id ? `&snapshot_id=${encodeURIComponent(selected.gold_snapshot_id)}` : ''}`}>Open full analysis</Link></Button>
