        ...
        <>
          <dl className="grid grid-cols-2 gap-x-4 gap-y-3.5 text-sm sm:grid-cols-3">
            ...
            <Info
              ...
              value={surfaceGravity > 0 ? `${number(surfaceGravity, 2)} cgs` : '—'}
            ...
            <Info
              ...
              value={hasTicContext && target.tess_mag > 0 ? `${number(target.tess_mag, 2)} Tmag` : '—'}
            ...
            <Info
              ...
              value={hzBoundaries ? `${hzBoundaries.luminosity.toFixed(3)} L☉` : '—'}
            ...
            <Info
              ...
              value={hzBoundaries ? `${hzBoundaries.consInnerAu.toFixed(2)} - ${hzBoundaries.consOuterAu.toFixed(2)} AU` : '—'}
            ...
            <Info
              ...
              value={hzBoundaries ? `${hzBoundaries.optInnerAu.toFixed(2)} - ${hzBoundaries.optOuterAu.toFixed(2)} AU` : '—'}
            ...
            <Info
              ...
              value={stellarDensity > 0 ? `${number(stellarDensity, 3)} g/cm³` : '—'}
            ...
            <Info
              ...
              value={escapeVelocity > 0 ? `${number(escapeVelocity, 0)} km/s` : '—'}
            ...
            <Info
              ...
              value={bolometricMag != null ? `${number(bolometricMag, 2)} mag` : '—'}
            ...
            <Info
              ...
              value={fluxStdPpm != null ? `${fluxStdPpm.toLocaleString()} ppm` : '—'}
            ...
            <Info
              ...
              value={fluxAmplitudePct != null ? `${fluxAmplitudePct}%` : '—'}
              tooltip="Biên độ dao động độ sáng cực đại của sao mẹ trong suốt thời gian quan sát Sector."
            />
            <Info
              label="Solar Ratio"
              value={`${starRadius.toFixed(2)}x R☉ · ${(starTeff / 5778).toFixed(2)}x T☉`}
          ...
          <div className="flex items-center justify-between border-t border-border/40 pt-2 text-xs text-muted-foreground">
            ...
            <span className={evolutionColor}>{evolutionStatus}</span>
          </div>
        </>
      ) : (
