...
// Shared target discovery surface used by both canonical and research routes.
              ...
              <Table className="min-w-[980px]">
                ...
                <TableBody>
                  {targets.map((target) => {
                    ...
                    const targetUrl = `/research-factory/workbench/${target.tic_id}?sector=${target.sector}${snapshotQuery}`;
                    return (
                      <TableRow
                        key={key}
