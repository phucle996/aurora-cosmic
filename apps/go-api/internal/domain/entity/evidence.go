...
type PipelineBatch struct {
	BatchID             string `json:"batch_id" ch:"batch_id"`
	Mode                string `json:"mode" ch:"mode"`
	Status              string `json:"status" ch:"status"`
	StartedAt           string `json:"started_at" ch:"started_at"`
	CompletedAt         string `json:"completed_at,omitempty" ch:"completed_at"`
	InputRecords        int64  `json:"input_records" ch:"input_records"`
	CandidateRows       int64  `json:"candidate_rows" ch:"candidate_rows"`
	ArtifactCount       int64  `json:"artifact_count" ch:"artifact_count"`
	IndexedRows         int64  `json:"indexed_rows" ch:"indexed_rows"`
	SnapshotID          string `json:"snapshot_id,omitempty" ch:"snapshot_id"`
	SnapshotFingerprint string `json:"snapshot_fingerprint,omitempty" ch:"snapshot_fingerprint"`
	ManifestKey         string `json:"manifest_key,omitempty" ch:"manifest_key"`
	ManifestSHA256      string `json:"manifest_sha256,omitempty" ch:"manifest_sha256"`
	Error               string `json:"error,omitempty" ch:"error"`
}

type PipelineComponentEvent struct {
	ComponentID  string `json:"component_id" ch:"component_id"`
	Status       string `json:"status" ch:"status"`
	OccurredAt   string `json:"occurred_at" ch:"occurred_at"`
	InputRecords int64  `json:"input_records" ch:"input_records"`
