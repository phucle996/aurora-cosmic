# AURORA Machine Learning Model Registry (Phase 6.5)

This document describes the package layout, champion / challenger promotion criteria, and rollback operations for AURORA models.
...
* Existing model packages are never modified or deleted.
